...
namespace BasicSendReceiveQuickStart
{
    class Program
    {
        ...
        {
            var serviceBusConnectionString = "Endpoint=sb://rmgdevservicebus.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=dD4IBvuXqsIleI9Pcaf7OiQfhiNK/+d74JJkVD5ImK4=";
